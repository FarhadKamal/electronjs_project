...
ipcMain.on("goods:planning:delete:request", function (e, id) {
  ...
  if (response == 0) {
    deleteQuery(id, function (reply) {
      ...
      else e.reply("goods:planning:list:deleted", reply);
    });
  }
});

ipcMain.on("goods:planning:edit:request", function (e, id) {
...
ipcMain.on("goods:planning:add:loaded", function (e, id) {
  e.reply("goods:planning:add:fetched", trackUnitData);
});

ipcMain.on("goods:planning:edit:loaded", function (e, id) {
  e.reply("goods:planning:edit:fetched", [trackData,trackUnitData]);
});

ipcMain.on("goods:planning:add:submit", function (e, item) {
  insert(item, function (reply) {
    e.reply("goods:planning:add:reply", reply);
  });
});

ipcMain.on("goods:planning:edit:submit", function (e, item) {
  update(item, function (reply) {
    e.reply("goods:planning:edit:reply", reply);
  });
});

ipcMain.on("goods:planning:add:click", function (e, item) {
  subWindow.loadFile("view/goods_planing/add.html");
});

ipcMain.on("goods:planning:list:click", function (e, item) {
  subWindow.loadFile("view/goods_planing/list.html");
});

ipcMain.on("goods:planning:list:loaded", function (e, item) {
  let html = "";
  ...
  get_list(function (rows) {
    ...
    e.reply("goods:planning:list:table", html);
  });
